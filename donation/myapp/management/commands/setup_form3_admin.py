...
class Command(BaseCommand):
    help = 'Set up form3_admin user with Form 3 level permissions'

    def add_arguments(self, parser):
        parser.add_argument('--username', type=str, default='form3_admin', help='Username for the Form 3 admin')
        parser.add_argument('--email', type=str, default='form3_admin@school.edu', help='Email for the Form 3 admin')
        parser.add_argument('--password', type=str, default='form3admin123', help='Password for the Form 3 admin')
    ...
    def handle(self, *args, **options):
        ...
        # Create or update level assignment for Form 3
        ...
        # Test the setup
        if profile.is_form3_admin():
            self.stdout.write(self.style.SUCCESS(f'✅ {username} is correctly set up as Form 3 admin'))
            ...
            self.stdout.write(self.style.ERROR(f'❌ {username} is NOT correctly set up as Form 3 admin'))
        
        self.stdout.write(self.style.SUCCESS(f'\nForm 3 admin setup complete!'))
        self.stdout.write(f'Username: {username}')
        self.stdout.write(f'Password: {password}')
        self.stdout.write(f'Dashboard URL: /form3-admin/dashboard/')
        self.stdout.write(f'Students URL: /form3-admin/students/')
