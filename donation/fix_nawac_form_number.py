...
def fix_nawac_form_number():
    """Fix Nawac Islam's form number and ensure school fees are assigned"""
    
    print("=" * 60)
    print("FIXING NAWAC ISLAM'S FORM NUMBER AND SCHOOL FEES")
    print("=" * 60)
    ...
    if not student:
        print("❌ Student Nawac Islam not found!")
        return
    ...
    # Update to Form 3 (you can change this to any form number)
    new_form_level = 'Form 3'
    ...
    # Remove old fee statuses that don't match Form 3
    ...
    # Generate new fee statuses for Form 3
    generated_count = 0
